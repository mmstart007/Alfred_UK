...
-(void) createSwipeViewIfNeeded
{
    ...
    if (!_rightView && _rightButtons.count > 0) {
        ...
        /* Piao */
        _rightView.frame = CGRectMake(_swipeOverlay.bounds.size.width - 7, _rightSwipeSettings.topMargin + 10, _rightView.bounds.size.width, _swipeOverlay.bounds.size.height - _rightSwipeSettings.topMargin - _rightSwipeSettings.bottomMargin - 20);
        _rightView.autoresizingMask = UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleHeight;
        
        _rightView.layer.cornerRadius = 12;
